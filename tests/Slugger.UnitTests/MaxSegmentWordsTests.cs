...
public sealed class MaxSegmentWordsTests
{
    ...
    {
        // Setup
        Theme theme = ThemeWith(adjectives: ["keen", "long forgotten"], nouns: ["moon"]);
    ...
    {
        // Setup
        Theme theme = ThemeWith(adjectives: ["keen"], nouns: ["moon", "harvest moon"]);
    ...
    {
        // Setup
        Theme theme = ThemeWith(adjectives: ["long forgotten", "all but forgotten"], nouns: ["moon"]);
    ...
    {
        // Setup
        Theme theme = ThemeWith(adjectives: ["keen"], nouns: ["harvest moon"]);
        ThemeResolver reduced = SlugGenerator.ResolverFor(
            theme,
            new GenerationOptions { Separator = '-', MaxSegmentWords = 1 });
    ...
    public void A_theme_states_its_own_cap_in_its_defaults()
    {
        ...
        const string Json = """
            ...
            """;
        Outcome<Theme> loaded = Themes.LoadFromJsonResult(Json, "theme", allowSmall: true);
    ...
    public void An_explicit_cap_outranks_the_one_the_theme_states()
    {
        ...
        const string Json = """
            ...
            """;
        Theme theme = Themes.LoadFromJsonResult(Json, "theme", allowSmall: true).GetResultOrThrow();
    ...
    {
        // Setup
        Theme theme = ThemeWith(adjectives: ["keen", "long forgotten"], nouns: ["harvest moon"]);
